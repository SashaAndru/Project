...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Апр 21 2024 г., 20:28
...
CREATE TABLE `Game` (
  ...
  `Name_game` varchar(85) COLLATE utf8mb4_general_ci NOT NULL,
  `descrip_game` text COLLATE utf8mb4_general_ci NOT NULL,
  `Foto_game` varchar(255) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `Users` (
  ...
  `SurName` varchar(70) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Father` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `Oblast` varchar(200) COLLATE utf8mb4_general_ci NOT NULL,
  `City` varchar(200) COLLATE utf8mb4_general_ci NOT NULL,
  `FullAddres` varchar(200) COLLATE utf8mb4_general_ci NOT NULL,
